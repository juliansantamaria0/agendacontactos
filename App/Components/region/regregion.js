      ...
      <style rel="stylesheet">
        ...
        <div class="card mt-3">
            <div class="card-header">
                Registro de regions <span class="badge rounded-pill text-bg-primary" id="idView"></span>
            </div>
            <div class="card-body">
                <form id="frmDataregion">
                    <div class="row">
                        ...
                        <div class="col">
                            <label for="apellidoregion" class="form-label">PaisId</label>
                            <input type="text" class="form-control" id="apellidoregion" name="apellidoregion">
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col">
