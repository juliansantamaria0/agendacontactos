      ...
      <style rel="stylesheet">
        ...
        <div class="card mt-3">
            <div class="card-header">
                Registro de companiess <span class="badge rounded-pill text-bg-primary" id="idView"></span>
            </div>
            <div class="card-body">
                <form id="frmDatacompanies">
                    <div class="row">
                        <div class="col">
                            <label for="nombrecompanies" class="form-label">Nombre companies</label>
                            <input type="text" class="form-control" id="nombrecompanies" name ="nombrecompanies">
                        </div>
                        <div class="col">
                            <label for="apellidocompanies" class="form-label">Apellidos companies</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            <label for="emailcompanies" class="form-label">Email</label>
