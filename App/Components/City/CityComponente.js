...
export class cityComponent extends HTMLElement {
  ...
  render() {
    this.innerHTML = /* html */ `
      ...
      <li class="nav-item">
        <a class="nav-link active mnucity" aria-current="page" href="#" data-verocultar='["#regcity",["#lstcity"]]'>Registrar city</a>
      </li>
      <li class="nav-item">
        <a class="nav-link mnucity" href="#" data-verocultar='["#lstcity",["#regcity"]]'>Listado de cities</a>
      </li>
    </ul>
