import {postContacts,patchContacts,deleteContacts} from '../../../Apis/cities/citiesApi.js';
import ContactModel from '../../../Models/CityModel.js';
      ...
      <style rel="stylesheet">
        ...
        <div class="card mt-3">
            <div class="card-header">
                Registro de citys <span class="badge rounded-pill text-bg-primary" id="idView"></span>
            </div>
            <div class="card-body">
                <form id="frmDatacity">
                    <div class="row">
                        <div class="col">
                            <label for="nombrecity" class="form-label">Nombre city</label>
                            <input type="text" class="form-control" id="nombrecity" name ="nombrecity">
                        </div>
                        <div class="col">
                            <label for="apellidocity" class="form-label">Apellidos city</label>
                            <input type="text" class="form-control" id="apellidocity" name="apellidocity">
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col">
